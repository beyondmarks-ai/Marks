...
2. Copy `.env.example` to `.env.local` and fill in the Firebase, Azure OpenAI, and ElevenLabs values. `ELEVENLABS_VOICE_ID` is optional and controls the text-to-speech voice.
